...
SECTOR_KEYWORDS = OrderedDict([
    ...
    ('光通信', ['光模块', '光通信', '薄膜铌酸锂', '滤光片', 'mpo', '光耦合器']),
    ('磷化铟', ['磷化铟']),
    ('光纤', ['光纤', '四氯化锗', '长飞']),
    ('PCB 钻针', ['钻针']),
    ...
    ('玻璃基板', ['玻璃基板', '硼硅', '玻璃基封装', '半导体显示', '光学玻璃']),
    ('电阻电容', ['电容', '被动元件', '电极箔', '超级电容', 'mlpc', '薄膜电容器']),
    ('功率半导体', ['功率半导体', 'igbt', 'mosfet', '功率器件']),
    ('半导体设备', ['半导体设备', '晶圆', '刻蚀', '封装检测', '半导体测试', '光刻机', '泵阀', '超洁净', '拓荆']),
    ('半导体材料', ['光刻胶', '电子气体', '特种气体', '特殊气体', '电子化学品', '半导体化学品', '硅烷', '有机硅', '电子特气', '光刻气', '靶材', 'coc', 'cop']),
    ('碳化硅', ['碳化硅', 'sic']),
    ('机器人', ['机器人', '人形机器人', '优必选', '电子皮肤', '宇树', 'peek', '机器狗']),
    ('存储', ['存储', '长鑫', 'hbm', 'dram', 'nand']),
    ('算力租赁', ['算力租赁']),
    ('算力调度/算力工厂', ['算力调度', '算力服务器', 'gpu', 'token工厂', '算力资产', '算力服务', '算力采购', 'ocs交换机', 'ocs交换']),
    ('电力', ['电力', '储能', '电网', '电气', '热电', '特高压', '发电', '充电桩', '煤电', '煤', 'hvdc', '算力电源', '风电', '算电协同']),
    ('小金属/贵金属', ['钨', '锡', '有色', '黄金', '铜', '锗', '钽', '铟', '铌', '铪', '锶', '金属', '铁矿', '矿产', '锌', '碲化铋']),
    ('AI 消费电子', ['ar眼镜', 'ar', 'miniled', 'ai眼镜', '折叠屏', 'ai手机']),
    ('AI 应用', ['ai应用', 'ai服务器', '推理服务器', 'ai智能体', 'ai算力', 'ai数据中心', 'aipc', '端侧ai', 'vr', 'ai语料', 'deepseek', '大模型', '混元', 'ai电商', 'ai音视频', 'ai影视', 'ai导购', 'ai短剧', 'ai金融']),
    ...
    ('核电', ['核电', '可控核聚变', '同位素']),
    ('AIDC-电源/发电机', ['发电机', '备用电源', 'hdvc', '数据中心电源']),
    ('AIDC-变压器', ['变压器', 'sst']),
    ('电池/储能', ['电池', '固态电池', '锂电池', '钠电池', '盐湖提锂', '提锂', '新能源', '磷化工', '锂电']),
    ('稀土', ['稀土']),
    ('油运', ['油运', '航运', '港口']),
    ('CPU', ['cpu']),
    ('半导体洁净室', ['洁净室']),
