...
SECTOR_KEYWORDS = OrderedDict([
    ...
    ('半导体材料', ['光刻胶', '电子气体', '特种气体', '特殊气体', '电子化学品', '半导体化学品', '硅烷', '有机硅', '电子特气', '光刻气', '靶材', 'coc', 'cop', '二氯二氢硅', '超纯氨', '石英坩埚', 'eda', '硅片', 'soi', '石英晶体']),
    ('碳化硅', ['碳化硅', 'sic']),
    ...
    ('电力', ['电力', '储能', '电网', '电气', '热电', '特高压', '发电', '充电桩', '煤电', '煤', 'hvdc', '算力电源', '风电', '算电协同', '电缆', '输配电', '取向硅钢']),
    ('电解铝', ['电解铝']),
    ('小金属/贵金属', ['钨', '锡', '有色', '黄金', '铜', '锗', '钽', '铟', '铌', '铪', '锶', '金属', '铁矿', '矿产', '锌', '碲化铋', '钼']),
    ('AI 消费电子', ['ar眼镜', 'ar', 'miniled', 'ai眼镜', '折叠屏', 'ai手机', '面板', 'oled', '光学镜头', 'tac膜', '微型电声元器件', '电声元器件']),
    ('AI 应用', ['ai应用', 'ai服务器', '推理服务器', 'ai智能体', 'ai算力', 'ai数据中心', 'aipc', '端侧ai', 'vr', 'ai语料', 'deepseek', '大模型', '混元', 'ai电商', 'ai音视频', 'ai影视', 'ai导购', 'ai短剧', 'ai金融', 'openclaw', '词元', 'cdn', 'ai出版', 'ai电影', '游戏', 'kimi', '阶跃星辰', '首发经济', '火山引擎', '智谱ai']),
