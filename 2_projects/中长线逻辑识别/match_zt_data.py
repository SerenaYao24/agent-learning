...
SECTOR_KEYWORDS = OrderedDict([
    ('CPO', ['cpo', '光引擎', '光模块', '光通信', '薄膜铌酸锂', '滤光片', 'mpo', '光耦合器', '高速连接', '高速连接器', '交换机', '激光']),
    ('MLCC 电容', ['mlcc', '离型膜']),
    ...
    ('半导体设备', ['半导体设备', '晶圆', '刻蚀', '封装检测', '半导体测试', '光刻机', '上海微电子', '泵阀', '超洁净', '拓荆', '质量控制', '量检测', '薄膜沉积', 'PECVD']),
    ('光刻胶', ['光刻胶', '光刻']),
    ('半导体材料', ['电子气体', '特种气体', '特殊气体', '电子化学品', '半导体化学品', '硅烷', '有机硅', '电子特气', '光刻气', '靶材', 'coc', 'cop', '二氯二氢硅', '超纯氨', '石英坩埚', 'eda', '硅片', 'soi', '石英晶体']),
    ('碳化硅', ['碳化硅', 'sic']),
    ...
    ('电网设备', ['电网', '虚拟电厂', '电力设备', '特高压', '电缆']),
    ('电力', ['电力', '储能', '电气', '热电', '发电', '充电桩', '煤电', '煤', 'hvdc', '算力电源', '风电', '算电协同', '输配电', '取向硅钢']),
    ('电解铝', ['电解铝']),
    ('小金属/贵金属', ['钨', '锡', '有色', '黄金', '铜', '锗', '钽', '铟', '铌', '铪', '锶', '金属', '铁矿', '矿产', '锌', '碲化铋', '钼']),
    ('AI 消费电子', ['ar眼镜', 'ar', 'miniled', 'ai眼镜', '折叠屏', 'ai手机', '面板', 'oled', '光学镜头', 'tac膜', '微型电声元器件', '电声元器件']),
    ('AI 应用', ['ai应用', 'ai服务器', '推理服务器', 'ai智能体', 'ai算力', 'ai数据中心', 'aipc', '端侧ai', 'vr', 'ai语料', 'deepseek', '大模型', '混元', 'ai电商', 'ai音视频', 'ai影视', 'ai导购', 'ai短剧', 'ai金融', 'openclaw', '词元', 'cdn', 'ai出版', 'ai电影', '版权', '游戏', 'kimi', '阶跃星辰', '首发经济', '火山引擎', '智谱ai']),
    ('低空经济', ['低空经济', '无人机', '飞行汽车', 'evtol']),
    ('量子科技', ['量子', '量子科技', '量子计算']),
    ('商业航天', ['航天', '商业航天', '卫星', '太空算力', '航空导航', '飞控', '航电', '航空复材', '碳纤维', '海上回收', '火箭']),
    ('军工', ['军工', '中兵', '兵器', '弹药', '导弹', '军机', '成飞', '航天军工']),
    ('中报预增', ['中报预增', '中报']),
    ('生物医药', ['创新药', 'cro', '仿制药', '原料药', '化学制药', '疫苗', '干细胞', '医疗器械', '体外诊断', '血液透析', '腹膜透析', '口腔', '医药流通', '医药电商', '医药批发', 'ai医疗', '智能医疗', '医疗']),
    ('脑机接口', ['脑机接口']),
    ('消费', ['服饰', '服装', '白酒', '百货', '零售', '预制菜', '旅游', '食品', '啤酒', '文旅', '豆制品', '五金', '电商直播', '果汁', '人造肉', '饮料', '瓶装水', '饮用水']),
    ('猪肉/养殖', ['猪肉', '养殖', '猪饲料', '饲料', '动物营养']),
    ('宠物经济', ['宠物', '宠物经济', '宠物用品', '母婴']),
    ('半导体', ['芯片', '射频', '射频芯片', '存储芯片', '光芯片', '集成电路']),
    ...
    ('化工', ['化工', '涤纶', 'pta', '化纤', '轮胎', '油脂化学', '表面活性剂', '钛白粉', '染料', '磷酸铁', '草铵膦', '农药原药', 'poe', 'eaa', '三乙胺', '铬盐', '氦气', '页岩气', 'sofc', '油气', '化肥', '纯碱', '甲醇', '氯碱', '钾肥', '生物柴油', 'tdi', '烧碱']),
