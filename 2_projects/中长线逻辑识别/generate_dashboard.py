...
.rank-tag.up{{background:#0a2a1a;color:#10b981;border:1px solid #1a4a2a}}
.rank-tag.down{{background:#2d1506;color:#f97316;border:1px solid #7c2d12}}
.rank-tag.none{{background:transparent;color:#4b5563;border:1px dashed #334155}}
...
function buildMa5Trend() {{
  ...
  function render(filterTheme) {{
    ...
    if (!filtered.length) {{ el.innerHTML = '<tr><td colspan="6" style="text-align:center;padding:24px;color:#6b7d95">暂无数据</td></tr>'; return; }}
